...
class Stegnography:
    ...
    def decoding(image):
        ...
        decoded_str = message_array.tostring()

        # split the string at the null character
        msg = decoded_str.split(b'\x00')[0].decode('utf-8')

        if len(msg) == "":
            return "The image is not decoded as it does not contain any message."
        return msg
    
obj = Stegnography()
#obj.encoding("color-image.jpg", "HEllo, this is secret.")
#msg = obj.decoding("static/images/enc_bw_image.png")
#print(msg)